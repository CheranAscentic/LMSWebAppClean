    ...
    public partial class InitialIdentityCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName", "UserType" },
                values: new object[,]
                {
                    { "1", null, "Member", "MEMBER", "Member" },
                    { "2", null, "StaffMinor", "STAFFMINOR", "StaffMinor" },
                    { "3", null, "StaffManagement", "STAFFMANAGEMENT", "StaffManagement" }
                });
